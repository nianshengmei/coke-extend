...
import pers.warren.coke.maven.plugin.loader.jar.JarFile;
...
public abstract class Launcher {
	...
	private static final String JAR_MODE_LAUNCHER = "pers.warren.coke.maven.plugin.jarmode.JarModeLauncher";
