...
import pers.warren.coke.maven.plugin.loader.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
	...
	private void clearCache(URLConnection connection) throws IOException {
		...
		if (jarFile instanceof pers.warren.coke.maven.plugin.loader.jar.JarFile) {
			((pers.warren.coke.maven.plugin.loader.jar.JarFile) jarFile).clearCache();
		}
	}
